...
module RV32ICore(
    ...
    output wire CPU_miss, CPU_access_signal,
    output wire CPU_BR_predict,CPU_BR_predict_miss, CPU_BP_update
    );
    ...
    assign CPU_access_signal = access_signal;
    ...
    assign CPU_BP_update = BP_update;
    assign BP_br = br;
    assign CPU_BR_predict_miss = br_predict_miss;
    ...
    PredictionMod BP (
        ...
        .update(BP_update),
        .br(BP_br),
        .br_predict_miss(br_predict_miss),
        .NPC(pc_predict),
        .br_predict_result(CPU_BR_predict)
    );
